    ...
    <div class="min-h-full">
        ...
        <header class="mt-16 bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Contact Me</h1>
            </div>
        </header>
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 grid-cols-1 lg:mt-5 ">
                    ...
                    <div class="max-w-lg mt-2 lg:mr-3 justify-self-center">
                        ...
                        <a href="mailto:joewilson502@gmail.com" class="flex align-baseline my-2 ml-1">
                            ...
                            <p class="ml-2 text-lg/8 text-gray-600">joewilson502@gmail.com</p>
                        </a>
                        <a href="https://www.linkedin.com/in/joe-wilson-b453b3205/" class="flex align-baseline my-2 ml-1">
                            ...
                            <p class="ml-2 text-lg/8 text-gray-600">LinkedIn</p>
                        </a>
                        <a href="https://github.com/joew502" class="flex align-baseline my-2 ml-1">
                    ...
                    <form action="#" method="POST" class="max-w-lg mt-5 lg:mt-0 lg:ml-3 justify-self-center">
                        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                            <div>
                                <label for="first-name" class="block text-base/6 font-semibold text-gray-900">First name</label>
                                <div class="mt-2.5">
                            ...
                            <div>
                                <label for="last-name" class="block text-base/6 font-semibold text-gray-900">Last name</label>
                                <div class="mt-2.5">
                            ...
                            <div class="sm:col-span-2">
                                <label for="company" class="block text-base/6 font-semibold text-gray-900">Company</label>
                                <div class="mt-2.5">
                            ...
                            <div class="sm:col-span-2">
                                <label for="email" class="block text-base/6 font-semibold text-gray-900">Email</label>
                                <div class="mt-2.5">
                            ...
                            <div class="sm:col-span-2">
                                <label for="phone-number" class="block text-base/6 font-semibold text-gray-900">Phone number</label>
                                <div class="mt-2.5">
                                    <input type="text" name="phone-number" id="phone-number" class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600">
                                </div>
                            </div>
                            <div class="sm:col-span-2">
                                <label for="message" class="block text-base/6 font-semibold text-gray-900">Message</label>
                                <div class="mt-2.5">
                            ...
                            <div class="flex gap-x-4 sm:col-span-2">
                                ...
                                <label class="text-base/6 text-gray-600" id="switch-1-label">
                                    By selecting this, you agree to our
                                    <a href="#" class="font-semibold text-[#ff914d]">privacy&nbsp;policy</a>.
                                </label>
                            </div>
                        </div>
                        <div class="mt-10">
